 ...
 const exchangeLabel = useMemo(() => {
  ...
  return (
    <div className="bg-gradient-to-br from-white to-gray-50 p-5 rounded-2xl  w-full h-96 overflow-hidden">
      ...
      {/* RATE */}
      <div className="text-[12px] text-gray-500 mb-4 transition-all duration-300">
        {exchangeLabel}
      </div>
      ...
      <div className={`flex items-center gap-2 mb-4 transition-all duration-300 ${animate ? "scale-95 opacity-70" : ""}`}>
        ...
        <select
          ...
          className="flex-1 border rounded-lg p-2 text-[12px] bg-white focus:ring-2 focus:ring-indigo-300 transition"
        >
          {currencies.map(c => (
      ...
      <div className="mb-3">
        ...
        <input
          ...
          className="w-full border rounded-lg p-2 text-[12px] focus:ring-2 focus:ring-indigo-300 transition"
        />
      </div>
      ...
      <div className="relative">
        ...
        <input
          ...
          value={converted}
          readOnly
          className="w-full border rounded-lg p-2 text-[12px] bg-gray-100 font-semibold transition-all duration-300 focus:ring-2 focus:ring-green-300"
        />
