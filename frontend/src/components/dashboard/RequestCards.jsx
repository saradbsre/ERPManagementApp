    ...
    <div className="bg-gradient-to-br from-white to-gray-50 p-5 rounded-2xl  w-full h-96 overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-xl text-[12px] font-medium transition shadow-sm
            ${
              requests.length > 0
      ...
      <div className="space-y-3 max-h-80 overflow-y-auto pr-1">
        ...
        {requests.map((req, index) => (
          ...
          >
            ...
            {/* BADGE */}
            <span className="text-[12px] px-3 py-1 rounded-full bg-yellow-100 text-yellow-700 font-medium">
              Pending
            </span>
